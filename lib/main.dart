      ...
      databaseProvider.getListEvent().then((list){
        if (list != null){
          ...
          if (list.length == 0){
            ...
            eventDef.eventName = "Pernikahan Kang Dadang dan Nyi Marsinah";
            eventDef.eventAddress = "Sukabumi";
  ...
  */
                ...
                databaseProvider.open().then((value){
                  ...
                  databaseProvider.deleteEvent(_event.eventId).then((event) {
                    ...
                    Fluttertoast.showToast(
                        msg: "Acara telah berhasil dihapus",
  ...
  Widget build(BuildContext context) {
    ...
    Widget  _blank = Center(
      child: Container(
        height: 40,
        child: Text("Belum ada acara yang tersedia disini"),
      ),
    );
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  "Silakan pilih acara yang telah tersedia, atau klik pada tombol tambah di bawah ini untuk membuat acara yang baru",
